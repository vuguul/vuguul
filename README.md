...
- Discord automation and admin tooling
- dashboards and internal panels
- licensing backends for desktop apps
- self-hosted infrastructure with Docker, Coolify, PostgreSQL, Redis, and MariaDB
...
- product engineering for bots, dashboards, licensing, and automation
